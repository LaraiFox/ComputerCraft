...
if (not __TURTLE_UTILS_INCLUDED) then
	...
	turtle.turnLeft = function(count)
		...
		if (count < 0) then turtle.right(-count) end
	...
	turtle.turnRight = function(count)
		if (count == nil) then count = 1 end
		if (count < 0) then turtle.left(-count) end
	...
	turtle.down = function(count)
		if (count == nil) then count = 1 end
		if (count < 0) then turtle.up(-count) end
	...
	turtle.up = function(count)
		if (count == nil) then count = 1 end
		if (count < 0) then turtle.down(-count) end
	...
	turtle.back = function(count)
		if (count == nil) then count = 1 end
		if (count < 0) then turtle.forward(-count) end
	...
	turtle.forward = function(count)
		if (count == nil) then count = 1 end
		if (count < 0) then turtle.back(-count) end
	...
	-- 3 inclusive the program exits and prints an error.
